...
{
    public class BFTCounterPayload : Payload
    {
        public int replicaid;
        public List<int> PVector {set; get;}
        public List<int> NVector {set; get;}

        public BFTCounterPayload(string uid, int numReplicas, int replicaid)
        {
            this.uid = uid;
        ...
        public BFTCounterPayload CloneValues()
        {
            // TODO: optimize
            BFTCounterPayload copy = new BFTCounterPayload(uid, this.PVector.Count, this.replicaid);
        ...
        public static BFTCounterPayload StrToPayload(string str)
        {
            BFTCounterPayload pl = new BFTCounterPayload("", (int)Config.numReplicas, (int)Config.replicaId);
